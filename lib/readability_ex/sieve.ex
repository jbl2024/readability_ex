    ...
    cond do
      ...
      true ->
        ...
        cleaned =
          ...
          |> Cleaner.clean_tag("form")
          |> Cleaner.clean_tag("fieldset")
          |> Cleaner.clean_tag("object")
          |> Cleaner.clean_tag("embed")
          |> Cleaner.clean_tag("footer")
          |> Cleaner.clean_tag("link")
          |> Cleaner.clean_tag("aside")
          |> Cleaner.clean_share_elements(Constants.default_char_threshold())
          |> Cleaner.clean_tag("iframe")
          |> Cleaner.clean_tag("input")
          |> Cleaner.clean_tag("textarea")
          |> Cleaner.clean_tag("select")
          |> Cleaner.clean_tag("button")
